...
public class ProductProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.admin.inventoryappstage2/products" will map to the
        ...
        // The content URI of the form "content://com.example.admin.inventoryappstage2/products/#" will map to the
        // integer code {@link #PRPODUCTS_ID}. This URI is used to provide access to ONE single row
        // of the products table.
        //
        // In this case, the "#" wildcard is used where "#" can be substituted for an integer.
        // For example, "content://com.example.admin.inventoryappstage2/products/3" matches, but
        // "content://com.example.admin.inventoryappstage2/products" (without a number at the end) doesn't match.
...
// Figure out if the URI matcher can match the URI to a specific code
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String name = ProductEntry.COLUMN_PRODUCT_NAME;
        if (name == null) {
...
// If the {@link ProductEntry#COLUMN_SUPPLIER_PHONE_NUMBER} key is present,
        ...
        if (values.containsKey(ProductEntry.COLUMN_SUPPLIER_PHONE_NUMBER)) {
            String phone = values.getAsString(ProductEntry.COLUMN_SUPPLIER_PHONE_NUMBER);
            if (phone == null) {
                throw new IllegalArgumentException("Product requires a valid phone");
            }
        }
